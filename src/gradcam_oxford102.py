...
MODEL_PATH = "./models/resnet50_oxford102_acc0.80.pth"
...
if __name__=="__main__":
    ...
    np.savetxt("grad_oxford_rot_vals_deg.txt", rot_vals_deg)
    np.savetxt("grad_oxford_trans_vals.txt", trans_vals)
    np.savetxt("grad_oxford_scales.txt", scales)
    ...
    if TO_APPEND_RESULTS:
        prev_results = pd.read_csv("grad_oxford_results.csv")
    ...
    for i, (inputs, targets) in enumerate(test_dl):
        ...
        plt.savefig(f"./outputs/gradcam/oxford/{i:02d}_t{target_class}_p{pred_class}_gradcam.jpg")
        plt.close()
        ...
        plt.savefig(f"./outputs/gradcam/oxford/{i:02d}_t{target_class}_p{t_pred_class}_gradcam_t.jpg")
        plt.close()
        ...
        plt.savefig(f"./outputs/gradcam/cifar/{i:02d}_t{target_class}_p{random_pred_class}_gradcam_random.jpg")
        plt.close()
        ...
        plt.savefig(f"./outputs/gradcam/oxford/{i:02d}_t{target_class}_p{rrr_pred_class}_gradcam_rrr.jpg")
        plt.close()
        ...
        plt.savefig(f"./outputs/gradcam/oxford/{i:02d}_t{target_class}_p{bgr_pred_class}_gradcam_bgr.jpg")
        plt.close()
        ...
        df.to_csv("grad_oxford_results.csv", index=False)
