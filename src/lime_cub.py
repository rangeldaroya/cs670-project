...
if __name__=="__main__":
    ...
    np.savetxt("lime_cub_rot_vals_deg.txt", rot_vals_deg)
    np.savetxt("lime_cub_trans_vals.txt", trans_vals)
    ...
    if TO_APPEND_RESULTS:
        prev_results = pd.read_csv("lime_cub_results.csv")
    ...
    for i, (inputs, targets) in enumerate(test_dl):
        ...
        plt.savefig(f"./outputs/lime/cub/{i:02d}_t{target_class}_p{pred_class}_shade.jpg")
        plt.close()
        ...
        plt.savefig(f"./outputs/lime/cub/{i:02d}_t{target_class}_p{rrr_pred_class}_rrr_shade.jpg")
        plt.close()
        ...
        plt.savefig(f"./outputs/lime/cub/{i:02d}_t{target_class}_p{bgr_pred_class}_bgr_shade.jpg")
        plt.close()
