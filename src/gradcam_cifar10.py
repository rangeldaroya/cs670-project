...
MODEL_PATH = "./models/resnet50_cifar10_acc0.82.pth"
...
if __name__=="__main__":
    ...
    np.savetxt("grad_cifar_scales.txt", scales)
    ...
    if TO_APPEND_RESULTS:
        prev_results = pd.read_csv("grad_cifar_results.csv")
    ...
    for i, (inputs, targets) in enumerate(test_dl):
        ...
        plt.savefig(f"./outputs/gradcam/cifar/{i:02d}_t{target_class}_p{pred_class}_gradcam.jpg")
        plt.close()
        ...
        plt.savefig(f"./outputs/gradcam/cifar/{i:02d}_t{target_class}_p{t_pred_class}_gradcam_t.jpg")
        plt.close()
        ...
        plt.savefig(f"./outputs/gradcam/cifar/{i:02d}_t{target_class}_p{rrr_pred_class}_gradcam_rrr.jpg")
        plt.close()
        ...
        plt.savefig(f"./outputs/gradcam/cifar/{i:02d}_t{target_class}_p{bgr_pred_class}_gradcam_bgr.jpg")
        plt.close()
        ...
        df.to_csv("grad_cifar_results.csv", index=False)
